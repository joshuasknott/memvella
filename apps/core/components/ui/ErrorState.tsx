...
export function ErrorState({
  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-surface px-6 py-10">
      <div className="w-full max-w-xl rounded-[32px] border border-border bg-surface p-8 shadow-xl">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-family-primary/70">
          Memvella
        </p>
        <h1 className="mt-4 font-family text-3xl font-extrabold tracking-tight text-text-primary">
          {title}
        </h1>
