...
export default function PrivacyPolicyPage() {
  return (
    <StaticPageLayout title="Privacy Policy">
      <p className="not-prose text-sm text-text-tertiary">
      ...
      <p>
        ...
        information - especially because Memvella is designed for families
        and trusted supporters caring for a senior through a shared Workspace.
      </p>
      ...
      <ul>
        ...
        <li>
          We don&apos;t send spam. You&apos;ll only hear from us with meaningful
          updates.
        </li>
      </ul>
      ...
      <h2>Cookies</h2>
      <p>
        Our website uses only the essential cookies needed to make the site
        work. No advertising cookies, no cross-site trackers.
      </p>

      <h2>Where your data lives</h2>
      <p>
        Your email address is stored securely using industry-standard
        encryption. We use trusted infrastructure providers with strong security
        practices.
      </p>
      ...
      <p>
        When we move beyond the waitlist, this policy will be updated to
        reflect exactly what data the product collects, how it&apos;s used, and
        what controls you have. We will always notify you before any changes
        take effect, and we will always err on the side of collecting less.
      </p>

      <h2>Questions?</h2>
      <p>
        If anything here is unclear, or if you have a concern, reach out to us
        at <a href="mailto:privacy@memvella.com">privacy@memvella.com</a>. A
