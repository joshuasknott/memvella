          ...
          <div className="flex flex-col">
            <FadeIn>
              <h1 className="font-headline text-4xl font-extrabold leading-[1.02] text-text-primary text-balance md:text-6xl">
                Daily support for seniors, guided by family and trusted supporters.
              </h1>
            </FadeIn>

            <FadeIn delay={100}>
              <p className="mt-6 max-w-xl text-lg leading-relaxed text-text-secondary md:text-xl">
                Memvella gives supporters one Workspace for routines, memories, People context, and companion tablet setup, while the senior gets a calm voice-first experience.
              </p>
            </FadeIn>
